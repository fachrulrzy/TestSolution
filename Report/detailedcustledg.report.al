report 50602 "Customer Invoice Detail Report"
{
    ...
    dataset
    {
        dataitem(salesInvoiceHeader; "Sales Invoice Header")
        {
            ...
            dataitem(custLedger; "Cust. Ledger Entry")
            {
                ...
                dataitem(dcl; "Detailed Cust. Ledg. Entry")
                {
                    DataItemLink = "Cust. Ledger Entry No." = field("Entry No.");
                    column(clen; "Cust. Ledger Entry No.")
                    {
                        IncludeCaption = true;
                    }
                    ...
                    var
                    begin
                        dcl.SetRange("Entry Type","Entry Type"::Application);
                        dcl.SetRange("Document No.", salesInvoiceHeader."No.");
                        dcl.SetRange("Document Type", custLedger."Document Type"::Payment);
                    end;
                }
                trigger OnPreDataItem()
                var
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = 'detailCustReport.rdl';
        }
    }
