report 50604 "Ext Report Fachrul"
{
        ...
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                begin
                    ...
                    // CETAK SEMUA KECUALI RETAIL
                    Line.SetFilter("Gen. Prod. Posting Group", '<>%1', 'RETAIL');
            ...
            begin
                ...
                // Header.SetRange("Sell-to Customer No.", stcn);
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                //         ApplicationArea = All;
                //         Caption = 'No.';
                //         ToolTip = 'Input Number Sales Invoice.';
                //         TableRelation = "Sales Invoice Header";
                //     }
                //     field(selltocustomer; stcn)
                //     {
                //         ApplicationArea = All;
                //         Caption = 'Sell-to Customer No.';
                //         ToolTip = 'Input Cutomer No.';
        ...
        begin
            ...
            // Header."No." := '103251' ;
            // Header."Sell-to Customer No." := '103251' ;
            // no := No_;

            
            // Message(No_);
            // stcn := Cn_;
            // sih.SetRange("No.", '103251');
            // varFilterPageBuilder.AddTable('Posted Sales Invoice', Database::"Sales Invoice Header");
            // varFilterPageBuilder.AddField('Posted Sales Invoice', sih."No.", '103251')
            // sih."No." := '103251';
            // Rec."No." := 
        end;
    }
